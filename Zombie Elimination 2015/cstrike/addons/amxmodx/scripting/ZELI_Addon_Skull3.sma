...
public plugin_init() 
{
	...
	register_clcmd("say /get21312321", "Get_Skull3")
	...
	g_Skull3 = ZombieEli_RegisterWeapon(g_Heavy, "CSO Skull3", WPN_PRIMARY, 7, 0)
}
...
{
	if(ItemID == g_Skull3) Get_Skull3(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_Skull3) Remove_Skull3(id)
}
