...
new g_Engineer, g_Thanatos91
new g_Medic, g_Thanatos92
new g_PyroTech, g_Thanatos93
new g_FrozenTech, g_Thanatos94
new g_Heavy, g_Thanatos95
...
public plugin_init()
{
	...
	//register_clcmd("say /get1231", "Get_Thanatos9")

	  /////////////////////////////////////////////
	 //   Register Weapon for Frozen Tech Class //
	/////////////////////////////////////////////
	g_FrozenTech = ZombieEli_GetClassID("Frozen Tech")
	g_Thanatos91 = ZombieEli_RegisterWeapon(g_FrozenTech, "CSO Thanatos-9", WPN_MELEE, 3, 1)
	
	  /////////////////////////////////////////////
	 //    Register Weapon for Pyro Tech Class  //
	/////////////////////////////////////////////	
	g_PyroTech = ZombieEli_GetClassID("Pyro Tech")
	g_Thanatos92 = ZombieEli_RegisterWeapon(g_PyroTech, "CSO Thanatos-9", WPN_MELEE, 3, 1)	

	  /////////////////////////////////////////////
	 //      Register Weapon for Medic Class    //
	/////////////////////////////////////////////	
	g_Medic = ZombieEli_GetClassID("Medic")
	g_Thanatos93 = ZombieEli_RegisterWeapon(g_Medic, "CSO Thanatos-9", WPN_MELEE, 3, 1)	

	  /////////////////////////////////////////////
	 //      Register Weapon for Heavy Class    //
	/////////////////////////////////////////////	
	g_Heavy = ZombieEli_GetClassID("Heavy")
	g_Thanatos94 = ZombieEli_RegisterWeapon(g_Heavy, "CSO Thanatos-9", WPN_MELEE, 3, 1)	
	
	  /////////////////////////////////////////////
	 //  Register Weapon for Engineer Class   //
	/////////////////////////////////////////////	
	g_Engineer = ZombieEli_GetClassID("Engineer")
	g_Thanatos95 = ZombieEli_RegisterWeapon(g_Engineer, "CSO Thanatos-9", WPN_MELEE, 3, 1)		
...
{
	if(ItemID == g_Thanatos91) Get_Thanatos9(id)
	if(ItemID == g_Thanatos92) Get_Thanatos9(id)
	if(ItemID == g_Thanatos93) Get_Thanatos9(id)
	if(ItemID == g_Thanatos94) Get_Thanatos9(id)
	if(ItemID == g_Thanatos95) Get_Thanatos9(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_Thanatos91) Remove_Thanatos9(id)
	if(ItemID == g_Thanatos92) Remove_Thanatos9(id)
	if(ItemID == g_Thanatos93) Remove_Thanatos9(id)
	if(ItemID == g_Thanatos94) Remove_Thanatos9(id)
	if(ItemID == g_Thanatos95) Remove_Thanatos9(id)
}
