...
#define CSW_POWERSAW CSW_KNIFE
#define weapon_powersaw "weapon_knife"
#define WEAPON_EVENT "events/knife.sc"
...
public plugin_init() 
{
	...
	g_PowerSaw = ZombieEli_RegisterWeapon(g_Heavy, "CSO Power Saw", WPN_MELEE, 2)	
}
...
public fw_Item_AddToPlayer_Post(ent, id)
{
	...
	write_string(g_Had_PowerSaw[id] == 1 ? "weapon_chainsaw" : "weapon_knife")
	...
	write_byte(g_Had_PowerSaw[id] == 1 ? CSW_POWERSAW : CSW_KNIFE) // WeaponID
	write_byte(0) // Flags
	message_end()
