...
#define V_MODEL "models/v_thompson.mdl"
#define P_MODEL "models/p_thompson.mdl"
//#define W_MODEL "models/w_thompson.mdl"
...
public plugin_init()
{
	...
	g_TommyGun = ZombieEli_RegisterWeapon(g_Engineer, "CSO TommyGun", WPN_PRIMARY, 0, 0)
}
...
public plugin_precache()
{
	...
	precache_sound("weapons/mg3_clipout.wav.wav")
...
{
	if(ItemID == g_TommyGun) Get_Weapon(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_TommyGun) Remove_Weapon(id)
}
