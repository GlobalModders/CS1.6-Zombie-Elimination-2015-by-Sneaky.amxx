...
#define PLUGIN "[ZD] Primary: Compound Bow"
#define VERSION "1.0"
#define AUTHOR "GLOBALMODDERS.NET | SORPACK.COM"

// =========== Resources Config
#define V_MODEL "models/ZombieDarkness/Weapon/Pri/v_bow.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Pri/p_bow.mdl"
#define P_MODEL_EMPTY "models/ZombieDarkness/Weapon/Pri/p_bow_empty.mdl"
//#define W_MODEL "models/ZombieDarkness/Weapon/Pri/w_bow.mdl"

#define ARROW_MODEl "models/ZombieDarkness/Weapon/Pri/arrow.mdl"
...
public plugin_init()
{
	...
	//g_CompoundBow = zd_weapon_register("Compound Bow", WEAPON_PRIMARY, CSW_BOW, 3999)
	
	g_Wukong = ZombieEli_GetClassID("Sun Wukong")
	g_Bow = ZombieEli_RegisterWeapon(g_Wukong, "CSO Compoud Bow", WPN_PRIMARY, 0, 1)
}
...
{
	if(ItemID == g_Bow) Get_CompoundBow(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_Bow) Remove_CompoundBow(id)
}


//public zd_weapon_addammo(id, ItemID)
//{
//	if(ItemID == g_CompoundBow) g_BowArrow[id] = ARROW_DEFAULT
//}
