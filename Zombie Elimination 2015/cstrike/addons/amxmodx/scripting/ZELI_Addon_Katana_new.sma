...
new g_PyroTech, g_Katana1
new g_FrozenTech, g_Katana2
new g_Medic, g_Katana3
new g_Heavy, g_Katana4
new g_Engineer, g_Katana5
...
public plugin_init()
{
	...
	g_Katana1 = ZombieEli_RegisterWeapon(g_PyroTech, "CSO Dual Katana", WPN_MELEE, 0, 0)
	
	g_FrozenTech = ZombieEli_GetClassID("Frozen Tech")
	g_Katana2 = ZombieEli_RegisterWeapon(g_FrozenTech, "CSO Dual Katana", WPN_MELEE, 0, 0)
	
	g_Engineer = ZombieEli_GetClassID("Engineer")
	g_Katana3 = ZombieEli_RegisterWeapon(g_Engineer, "CSO Dual Katana", WPN_MELEE, 0, 0)
	
	g_Medic = ZombieEli_GetClassID("Medic")
	g_Katana4 = ZombieEli_RegisterWeapon(g_Medic, "CSO Dual Katana", WPN_MELEE, 0, 0)

	g_Heavy = ZombieEli_GetClassID("Heavy")
	g_Katana5 = ZombieEli_RegisterWeapon(g_Heavy, "CSO Dual Katana", WPN_MELEE, 0, 0)
}
...
{
	if(ItemID == g_Katana1) get_dualkatana(id)
	if(ItemID == g_Katana2) get_dualkatana(id)
	if(ItemID == g_Katana3) get_dualkatana(id)
	if(ItemID == g_Katana4) get_dualkatana(id)
	if(ItemID == g_Katana5) get_dualkatana(id)	

}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_Katana1) remove_dualkatana(id)
	if(ItemID == g_Katana2) remove_dualkatana(id)
	if(ItemID == g_Katana3) remove_dualkatana(id)
	if(ItemID == g_Katana4) remove_dualkatana(id)
	if(ItemID == g_Katana5) remove_dualkatana(id)	
}
