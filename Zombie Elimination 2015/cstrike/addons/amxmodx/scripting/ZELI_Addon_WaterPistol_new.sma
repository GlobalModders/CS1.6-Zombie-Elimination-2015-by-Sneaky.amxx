...
new g_WaterPistol1, g_FrozenTech
new g_WaterPistol2, g_PyroTech
new g_WaterPistol3, g_Engineer
new g_WaterPistol4, g_Medic
new g_WaterPistol5, g_Heavy
new g_WaterPistol6, g_Wukong
...
public plugin_init()
{
	...
	g_WaterPistol1 = ZombieEli_RegisterWeapon(g_FrozenTech, "CSO Sha Wujing", WPN_SECONDARY, 0, 0)
	
	  /////////////////////////////////////////////
	 //  Register Weapon for Pyro Tech Class  //
	/////////////////////////////////////////////	
	g_PyroTech = ZombieEli_GetClassID("Pyro Tech")
	g_WaterPistol2 = ZombieEli_RegisterWeapon(g_PyroTech, "CSO Sha Wujing", WPN_SECONDARY, 0, 0)	

	  /////////////////////////////////////////////
	 //    Register Weapon for Medic Class    //
	/////////////////////////////////////////////	
	g_Medic = ZombieEli_GetClassID("Medic")
	g_WaterPistol3 = ZombieEli_RegisterWeapon(g_Medic, "CSO Sha Wujing", WPN_SECONDARY, 0, 0)	

	  /////////////////////////////////////////////
	 //    Register Weapon for Heavy Class    //
	/////////////////////////////////////////////	
	g_Heavy = ZombieEli_GetClassID("Heavy")
	g_WaterPistol4 = ZombieEli_RegisterWeapon(g_Heavy, "CSO Sha Wujing", WPN_SECONDARY, 0, 0)	
	
	  /////////////////////////////////////////////
	 //  Register Weapon for Engineer Class   //
	/////////////////////////////////////////////	
	g_Engineer = ZombieEli_GetClassID("Engineer")
	g_WaterPistol5 = ZombieEli_RegisterWeapon(g_Engineer, "CSO Sha Wujing", WPN_SECONDARY, 0, 0)	
	
	  /////////////////////////////////////////////
	 //   Register Weapon for Wukong Class    //
	/////////////////////////////////////////////	
	g_Wukong = ZombieEli_GetClassID("Sun Wukong")
	g_WaterPistol6 = ZombieEli_RegisterWeapon(g_Wukong, "Sha Wujing", WPN_SECONDARY, 0, 0)	
}
...
{
	if(ItemID == g_WaterPistol1) get_weapon(id)
	if(ItemID == g_WaterPistol2) get_weapon(id)
	if(ItemID == g_WaterPistol3) get_weapon(id)
	if(ItemID == g_WaterPistol4) get_weapon(id)
	if(ItemID == g_WaterPistol5) get_weapon(id)
	if(ItemID == g_WaterPistol6) get_weapon(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_WaterPistol1) remove_weapon(id)
	if(ItemID == g_WaterPistol2) remove_weapon(id)
	if(ItemID == g_WaterPistol3) remove_weapon(id)
	if(ItemID == g_WaterPistol4) remove_weapon(id)
	if(ItemID == g_WaterPistol5) remove_weapon(id)
	if(ItemID == g_WaterPistol6) remove_weapon(id)
}
