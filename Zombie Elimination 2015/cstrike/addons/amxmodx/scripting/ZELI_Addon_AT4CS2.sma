...
public plugin_init()
{
	...
	register_clcmd("say /get11", "Get_AT4CS")
	register_clcmd("weapon_at4cs", "Hook_Weapon")
	
	//g_Heavy = ZombieEli_GetClassID("Heavy")
	//g_AT4CS = ZombieEli_RegisterWeapon(g_Heavy, "CSO AT4CS", WPN_PRIMARY, 5, 0)	
...
{
	register_native("Are_You_A_Fucker", "Native_Fucker", 1)
}

public Native_Fucker(id)
{
	if(!is_alive(id))
		return 0
...
//{
//	if(ItemID == g_AT4CS) Get_AT4CS(id)
//}

//public zeli_weapon_removed(id, ItemID)
//{
//	if(ItemID == g_AT4CS) Remove_AT4CS(id)
//}
