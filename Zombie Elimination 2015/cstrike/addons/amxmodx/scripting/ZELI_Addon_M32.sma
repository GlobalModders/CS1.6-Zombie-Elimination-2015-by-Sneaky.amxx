...
public plugin_init()
{
	...
	register_clcmd("say /get313", "Get_M32")
	register_clcmd("weapon_M32", "Hook_Select")

	g_Engineer = ZombieEli_GetClassID("Engineer")
	g_M32 = ZombieEli_RegisterWeapon(g_Engineer, "CSO M32", WPN_PRIMARY, 3, 0)	
}
...
{
	if(ItemID == g_M32) Get_M32(id)
}
public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_M32) Remove_M32(id)
}
public Remove_M32(id)
{
	drop_weapons(id, 1)
	g_has_M32[id] = false
}
