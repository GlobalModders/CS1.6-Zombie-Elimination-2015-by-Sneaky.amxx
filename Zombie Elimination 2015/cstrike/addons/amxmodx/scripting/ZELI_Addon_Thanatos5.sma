...
#define VERSION "1.0"
#define AUTHOR "Sneaky.amxx | SORPACK.COM"
...
new g_FrozenTech, g_Thanatos51
new g_PyroTech, g_Thanatos52
new g_Medic, g_Thanatos53
new g_Engineer, g_Thanatos54
new g_Heavy, g_Thanatos55
new g_Wukong, g_Thanatos56
...
public plugin_init() 
{
	...
	//register_clcmd("say /dasdaget", "Get_Thanatos5", ADMIN_KICK)
	...
	g_Thanatos51 = ZombieEli_RegisterWeapon(g_FrozenTech, "CSO Thanatos-5", WPN_PRIMARY, 4, 1)
	
	  /////////////////////////////////////////////
	 //  Register Thanatos for Pyro Tech Class  //
	/////////////////////////////////////////////	
	g_PyroTech = ZombieEli_GetClassID("Pyro Tech")
	g_Thanatos52 = ZombieEli_RegisterWeapon(g_PyroTech, "CSO Thanatos-5", WPN_PRIMARY, 4, 1)	

	  /////////////////////////////////////////////
	 //    Register Thanatos for Medic Class    //
	/////////////////////////////////////////////	
	g_Medic = ZombieEli_GetClassID("Medic")
	g_Thanatos53 = ZombieEli_RegisterWeapon(g_Medic, "CSO Thanatos-5", WPN_PRIMARY, 4, 1)	

	  /////////////////////////////////////////////
	 //    Register Thanatos for Heavy Class    //
	/////////////////////////////////////////////	
	g_Heavy = ZombieEli_GetClassID("Heavy")
	g_Thanatos54 = ZombieEli_RegisterWeapon(g_Heavy, "CSO Thanatos-5", WPN_PRIMARY, 4, 1)	
	
	  /////////////////////////////////////////////
	 //  Register Thanatos for Engineer Class   //
	/////////////////////////////////////////////	
	g_Engineer = ZombieEli_GetClassID("Engineer")
	g_Thanatos55 = ZombieEli_RegisterWeapon(g_Engineer, "CSO Thanatos-5", WPN_PRIMARY, 4, 1)	
	
	  /////////////////////////////////////////////
	 //   Register Thanatos for Wukong Class    //
	/////////////////////////////////////////////	
	g_Wukong = ZombieEli_GetClassID("Sun Wukong")
	g_Thanatos56 = ZombieEli_RegisterWeapon(g_Wukong, "CSO Thanatos-5", WPN_PRIMARY, 4, 1)	
}
...
{
	if(ItemID == g_Thanatos51) Get_Thanatos5(id)
	if(ItemID == g_Thanatos52) Get_Thanatos5(id)
	if(ItemID == g_Thanatos53) Get_Thanatos5(id)
	if(ItemID == g_Thanatos54) Get_Thanatos5(id)
	if(ItemID == g_Thanatos55) Get_Thanatos5(id)
	if(ItemID == g_Thanatos56) Get_Thanatos5(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_Thanatos51) Remove_Thanatos5(id)
	if(ItemID == g_Thanatos52) Remove_Thanatos5(id)
	if(ItemID == g_Thanatos53) Remove_Thanatos5(id)
	if(ItemID == g_Thanatos54) Remove_Thanatos5(id)
	if(ItemID == g_Thanatos55) Remove_Thanatos5(id)
	if(ItemID == g_Thanatos56) Remove_Thanatos5(id)
}
