...
#define PLUGIN "[ZD] Primary: M14EBR"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define V_MODEL "models/ZombieDarkness/Weapon/Pri2/v_m14master.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Pri2/p_m14master.mdl"
...
public plugin_init()
{
	...
	//g_Weapon = zd_weapon_register("M14EBR", WEAPON_PRIMARY, CSW_BASEDON, 0)
	
	g_Engineer = ZombieEli_GetClassID("Engineer")
	g_m14ebr = ZombieEli_RegisterWeapon(g_Engineer, "CSO M14-EBR", WPN_PRIMARY, 3, 0)		
}
...
{
	if(ItemID == g_m14ebr) Get_Weapon(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_m14ebr) Remove_Weapon(id)
}
