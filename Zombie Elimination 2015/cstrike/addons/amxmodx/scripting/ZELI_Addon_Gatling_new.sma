...
public plugin_init() 
{
	...
	g_Gatling = ZombieEli_RegisterWeapon(g_PyroTech, "CSO Fire Gatling", WPN_PRIMARY, 4, 0)	
}
...
public fw_TraceAttack(ent, attacker, Float:Damage, Float:fDir[3], ptr, iDamageType)
{
	...
	if(is_user_alive(ent)) PyroTech_AfterBurn(ent, attacker)
