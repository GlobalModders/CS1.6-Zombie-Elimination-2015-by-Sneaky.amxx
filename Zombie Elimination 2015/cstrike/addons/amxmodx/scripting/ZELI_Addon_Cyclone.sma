...
#define PLUGIN "[ZELI] Addon: Cyclone"
#define VERSION "1.0"
...
#define V_MODEL "models/v_sfpistol2.mdl"
...
public plugin_init() 
{
	...
	g_Cyclone = ZombieEli_RegisterWeapon(g_PyroTech, "Cyclone", WPN_SECONDARY, 10, 0)
...
{
	if(ItemID == g_Cyclone) UnSet_BitVar(g_Had_Cyclone, id)
}
...
public Create_Laser(id, Ent)
{
	...
	if(is_user_alive(Hit)) 
	{
		...
		if(is_user_alive(Hit)) PyroTech_AfterBurn(Hit, id)
	}
