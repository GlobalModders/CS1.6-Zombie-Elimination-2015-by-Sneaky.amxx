...
#define PLUGIN "[ZD] Primary: WA2000"
#define VERSION "1.0"
#define AUTHOR "SORPACK.COM | GLOBALMODDERS.NET"

#define V_MODEL "models/ZombieDarkness/Weapon/Pri2/v_wa2000_+8.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Pri2/p_wa2000_+8.mdl"
...
#define WEAPON_SECRETCODE 5451537
...
public plugin_init()
{
	...
	//g_Weapon = zd_weapon_register("WA2000", WEAPON_PRIMARY, CSW_BASEDON, 7000)

	g_PyroTech = ZombieEli_GetClassID("Pyro Tech")
	g_wa2000 = ZombieEli_RegisterWeapon(g_PyroTech, "CSO WA2000 Sniper", WPN_PRIMARY, 0, 0)	
}
...
{
	if(ItemID == g_wa2000) Get_Weapon(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_wa2000) Remove_Weapon(id)
}
