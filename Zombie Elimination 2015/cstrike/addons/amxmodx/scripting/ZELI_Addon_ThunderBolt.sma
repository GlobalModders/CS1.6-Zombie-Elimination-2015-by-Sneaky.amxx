...
#define PLUGIN "[ZD] Primary: Thunderbolt"
#define VERSION "1.0"
#define AUTHOR "Dias"
...
#define V_MODEL "models/ZombieDarkness/Weapon/Pri/v_sfsniper3.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Pri/p_sfsniper.mdl"
//#define W_MODEL "models/ZombieDarkness/Weapon/Pri/w_sfsniper.mdl"
...
//new Thunderbolt
new g_Had_Thunderbolt, g_Zoomed
new g_IsAlive
new Float:CheckDelay[33], Float:CheckDelay2[33], g_TempAttack
new g_Msg_CurWeapon, g_Msg_AmmoX, g_Msg_WeaponList
new g_Beam_SprId, g_HamBot_Register, g_Event_Thunderbolt

new g_Thunderbolt, g_FrozenTech
...
public plugin_init() 
{
	...
	register_clcmd("weapon_sfsniper2", "CLCMD_HookWeapon")
	//Thunderbolt = zd_weapon_register("Thunderbolt", WEAPON_PRIMARY, CSW_THUNDERBOLT, 13000)
	
	g_FrozenTech = ZombieEli_GetClassID("Frozen Tech")
	g_Thunderbolt = ZombieEli_RegisterWeapon(g_FrozenTech, "CSO ThunderBolt Sniper", WPN_PRIMARY, 0, 0)
...
//{
//	if(ItemID == Thunderbolt) Remove_Thunderbolt(id)
//}

//public zd_weapon_addammo(id, ItemID)
//{
//	if(ItemID == Thunderbolt) 
//	{
...
public fw_CmdStart(id, UcHandle, Seed)
{
	...
	if(get_gametime() - 0.5 > CheckDelay2[id])
	{
		static Body, Target; get_user_aiming(id, Target, Body, 99999)
		
		if(Get_BitVar(g_IsAlive, Target) && cs_get_user_zoom(id) > 1)  emit_sound(id, CHAN_WEAPON, WeaponSounds[1], VOL_NORM, ATTN_NORM, 0, PITCH_NORM)
...
public fw_AddToPlayer_Post(ent, id)
{
	...
	write_string((Get_BitVar(g_Had_Thunderbolt, id) ? "weapon_sfsniper2" : "weapon_awp"))
	write_byte(1)
	write_byte(30)
	write_byte(-1)
	write_byte(-1)
