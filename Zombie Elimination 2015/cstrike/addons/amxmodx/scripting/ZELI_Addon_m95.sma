...
#define PLUGIN "[ZD] Primary: M95"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define V_MODEL "models/ZombieDarkness/Weapon/Pri2/v_m95_+8.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Pri2/p_m95_+8.mdl"
...
#define WEAPON_SECRETCODE 54554326
...
public plugin_init()
{
	...
	//g_Weapon = zd_weapon_register("Barrett M95", WEAPON_PRIMARY, CSW_BASEDON, 6000)
	
	g_Heavy = ZombieEli_GetClassID("Heavy")
	g_m95 = ZombieEli_RegisterWeapon(g_Heavy, "CSO M95 Sniper", WPN_PRIMARY, 0, 0)
}
...
{
	if(ItemID == g_m95) Get_Weapon(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_m95) Remove_Weapon(id)
}
