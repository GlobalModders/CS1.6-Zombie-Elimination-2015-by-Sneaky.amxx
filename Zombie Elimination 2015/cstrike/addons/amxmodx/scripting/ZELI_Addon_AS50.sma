...
#define PLUGIN "[ZD] Primary: AS50"
#define VERSION "1.0"
#define AUTHOR "Dias"

#define V_MODEL "models/ZombieDarkness/Weapon/Pri2/v_as50.mdl"
#define P_MODEL "models/ZombieDarkness/Weapon/Pri2/p_as50.mdl"
...
public plugin_init()
{
	...
	//g_Weapon = zd_weapon_register("AI AS50", WEAPON_PRIMARY, CSW_BASEDON, 12000)

	g_Medic = ZombieEli_GetClassID("Medic")
	g_as50 = ZombieEli_RegisterWeapon(g_Medic, "CSO AS50 Sniper", WPN_PRIMARY, 0, 0)		
}
...
{
	if(ItemID == g_as50) Get_Weapon(id)
}

public zeli_weapon_removed(id, ItemID)
{
	if(ItemID == g_as50) Remove_Weapon(id)
}
