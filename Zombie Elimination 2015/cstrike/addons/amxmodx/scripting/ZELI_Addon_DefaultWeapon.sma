...
new g_Sec_USP, g_Sec_Glock18, g_Sec_P228, g_Sec_FiveSeven, g_Sec_DualElite
...
{
	// Primary
	g_Pri_M4A1 = ZombieEli_RegisterWeapon(g_FrozenTech, "M4A1 Carbine", WPN_PRIMARY, 0, 0)
	g_Pri_AK47 = ZombieEli_RegisterWeapon(g_FrozenTech, "AK-47 Kalashnikov", WPN_PRIMARY, 0, 0)
	g_Pri_AUG = ZombieEli_RegisterWeapon(g_FrozenTech, "Steyr AUG A1", WPN_PRIMARY, 0, 0)
	g_Pri_SG552 = ZombieEli_RegisterWeapon(g_Engineer, "SG-552 Commando", WPN_PRIMARY, 0, 0)
	g_Pri_Galil = ZombieEli_RegisterWeapon(g_Engineer, "IMI Galil", WPN_PRIMARY, 0, 0)
	g_Pri_M3 = ZombieEli_RegisterWeapon(g_Engineer, "M3 Super 90", WPN_PRIMARY, 0, 0)
	g_Pri_XM1014 = ZombieEli_RegisterWeapon(g_Heavy, "XM1014 M4", WPN_PRIMARY, 0, 0)
	g_Pri_AWP = ZombieEli_RegisterWeapon(g_Heavy, "AWP Magnum Sniper", WPN_PRIMARY, 0, 0)
	g_Pri_Scout = ZombieEli_RegisterWeapon(g_Heavy, "Schmidt Scout", WPN_PRIMARY, 0, 0)
	g_Pri_Famas = ZombieEli_RegisterWeapon(g_Heavy, "Famas", WPN_PRIMARY, 0, 0)
	g_Pri_MP5 = ZombieEli_RegisterWeapon(g_Medic, "MP5 Navy", WPN_PRIMARY, 0, 0)
	g_Pri_P90 = ZombieEli_RegisterWeapon(g_Medic, "ES P90", WPN_PRIMARY, 0, 0)
	g_Pri_UMP45 = ZombieEli_RegisterWeapon(g_Medic, "UMP 45", WPN_PRIMARY, 0, 0)
	g_Pri_MAC = ZombieEli_RegisterWeapon(g_PyroTech, "Ingram MAC-10", WPN_PRIMARY, 0, 0)
	g_Pri_TMP = ZombieEli_RegisterWeapon(g_PyroTech, "Schmidt TMP", WPN_PRIMARY, 0, 0)
	
	// Secondary
	g_Sec_USP = ZombieEli_RegisterWeapon(g_FrozenTech, "USP .45 ACP Tactical", WPN_SECONDARY, 0, 0)
	g_Sec_Glock18 = ZombieEli_RegisterWeapon(g_Engineer, "Glock 18C", WPN_SECONDARY, 0, 0)
	//g_Sec_DE = ZombieEli_RegisterWeapon(g_Engineer, "Desert Eagle .50 AE", WPN_SECONDARY, 0, 0)
	g_Sec_P228 = ZombieEli_RegisterWeapon(g_Heavy, "P228 Compact", WPN_SECONDARY, 0, 0)
	g_Sec_FiveSeven = ZombieEli_RegisterWeapon(g_Medic, "FiveseveN", WPN_SECONDARY, 0, 0)
	g_Sec_DualElite = ZombieEli_RegisterWeapon(g_PyroTech, "Dual Elite Berettas", WPN_SECONDARY, 0, 0)
}
